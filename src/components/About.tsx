      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="relative mx-auto lg:mx-0 max-w-md lg:max-w-none">
            ...
            {/* Floating Card */}
            <div className="absolute -bottom-2 sm:-bottom-3 lg:-bottom-4 -right-2 sm:-right-4 bg-card p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-card border border-primary/20">
